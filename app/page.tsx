  ...
  return (
    <HomePageContainer>
      ...
      <div className="flex flex-col justify-center min-h-max sm:mt-[5vh]">
        <p className="mt-0.5 hidden sm:block">{homePage.gameComment}</p>
        <p className="mt-0.5 sm:hidden">{homePage.gameCommentMobile}</p>
        <p className="mt-0.5">{homePage.githubComment}</p>
